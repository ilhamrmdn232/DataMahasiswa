...
<html lang="en">
  ...
  <div>
    <nav class="navbar bg-dark">
      <div class="container-fluid">
        <a href="" class="text-white" style="text-decoration: none; font-size: 23px;"><img src="img/imgg.png" alt="" style="width: 58px; height: 50px;"> Universitas Pelita Bangsa</a>
      </div>
    </nav>
  </div>
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/></svg> Data Absensi Kelas</caption>
...
<footer class="bg-dark" style="text-align: center; padding: 10px; color: white; position: fixed; left: 0; bottom: 0; width: 100%;">
